...
私は彼女のような人が世の中に五万といると思っています。そういう人に使って頂きたいという思いからこのアプリケーションの開発をはじめました。このアプリケーションではアーティストとして本名ではなくアーティスト名で登録して頂きます。また、本名で活動したい人のためにも本名のform欄も設けております。
技術どうこうに関わらずどのユーザーもアーティストとして自分のポートフォリオのようなページを持ち、ギャラリーには作品を出展できます。そして、それを他のユーザーにみてもらうことができます。
